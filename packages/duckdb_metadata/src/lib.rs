...
impl MetadataFields {
    pub fn write(&self, mut write: impl io::Write) -> io::Result<()> {
        ...
        let metadata_fields_section_len =
            leb128::write::unsigned(&mut { &mut metadata_field_section_bytes[..] }, metadata_fields_size as u64).unwrap();
        let metadata_fields_section_len_bytes = &metadata_field_section_bytes[0..metadata_fields_section_len];

        let custom_section_name = b"duckdb_signature";

        let mut custom_section_name_bytes = [0u8; 10];
        let custom_section_name_len =
            leb128::write::unsigned(&mut { &mut custom_section_name_bytes[..] }, custom_section_name.len() as u64).unwrap();
        let custom_section_name_len_bytes = &custom_section_name_bytes[..custom_section_name_len];

        let metadata_fields_size =
        custom_section_name_len_bytes.len() +
...

        {
            ...
            let len =
                leb128::write::unsigned(&mut { &mut bytes[..] }, metadata_fields_size as u64).unwrap();
...
mod tests {
    ...
    fn test_create_metadata_section() -> Result<(), InputTooLongError> {
        ...
        let expected: [u8; 0x216] = [
            0x00, 0x93, 0x04, 0x10, 0x64, 0x75, 0x63, 0x6B, 0x64, 0x62, 0x5F, 0x73, 0x69, 0x67, 0x6E, 0x61,
            0x74, 0x75, 0x72, 0x65, 0x80, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            ...
            ,
